...
Всё в одном файле специально, чтобы было легко объяснить преподавателю.
Сущности: groups -> students, disciplines, study_plans, grades.
Бизнес-правило: оценку можно поставить ТОЛЬКО если эта дисциплина
есть в учебном плане группы студента на этот семестр, и оценка 2-5.
"""
import os
import sqlite3
